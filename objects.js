...
let objToMax = { 1: 2, 2: 3 }
maxedOut(objToMax);
console.log(objToMax);
...
console.log(getValues(favoriteThings));
/// ////////////// PROBLEM 11 ////////////////////
...
function recordCleaner(obj) {
  for (const accident in obj.accidents) {
    obj.accidents[accident].atFaultForAccident = false;
  }
}
recordCleaner(myCar);
